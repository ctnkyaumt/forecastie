...
A simple, copylefted libre software weather app for Android. It gathers data from [Open-Meteo](https://open-meteo.com/), via their public API.
...
The weather data is provided by [Open-Meteo](https://open-meteo.com/), under the <a href='https://creativecommons.org/licenses/by/4.0/'>Creative Commons Attribution 4.0 International License</a>.
